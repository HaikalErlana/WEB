    ...
    <style>
        * {
        ...
        .hero .gambar {
            ...
            background-image: url('imageProduk/asss.png');
        ...
        <li class="produk">
            ...
            ?>
                <ul class="list-produk">
                    <li><img src="imageProduk/<?= $row['foto']; ?>" alt="" width="100px" height="100px"></li>
                    <li><?php echo $row['nama_produk']; ?> <br> stok : <?php echo $row['stok'];?></li>
